...
Route::middleware(['auth', 'verified', 'role:admin'])->group(function () {
    ...
    Route::get('yeast-registrations/{yeastRegistration}/edit', [YeastRegistrationController::class, 'edit'])->name('yeast-registrations.edit');
    Route::patch('yeast-registrations/{yeastRegistration}', [YeastRegistrationController::class, 'update'])->name('yeast-registrations.update');
    Route::delete('yeast-registrations/{yeastRegistration}', [YeastRegistrationController::class, 'destroy'])->name('yeast-registrations.destroy');
